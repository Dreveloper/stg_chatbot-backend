...
if the question ask for clnical features, investigations, or management, provide a complete and structured answer using bullet points.
if the question asks for dose or single facts, answer concisely.
